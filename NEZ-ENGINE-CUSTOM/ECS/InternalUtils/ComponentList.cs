using NEZ_ENGINE_CUSTOM.ECS.Networking.Network_Components;
using System;
...
namespace Nez
{
	public class ComponentList
	{
        ...
        Lazy<FastList<INetworkComponent>> _networkingComponents = new Lazy<FastList<INetworkComponent>>(delegate ()
        {
            return new FastList<INetworkComponent>();
        }, false);
		...
		public void removeAllComponents()
		{
            ...
            _networkingComponents.Value.clear();
